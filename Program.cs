 ...
 * if user gets 3 points, user wins
 * if cpu gets 3 points, cpu wins
 * best to N input by player, wins
*/
char[] choices = { 'r', 's', 'p' };
...
Console.WriteLine("Choose an odd number as the number of games you want to play");
